...
<div class="container mx-auto p-6">
    ...
    <form action="{{ route('admin.kantin.store') }}" method="POST" class="space-y-4">
        ...
        <div class="form-group">
            ...
            <input type="text" name="nama_kantin" id="nama_kantin" class="block w-1/2 px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-150 ease-in-out sm:text-sm" value="{{ old('nama_kantin') }}" required placeholder="Masukkan nama kantin">
        </div>
